    ...
    var setDefaultValues = function(){
        for (inputKey in inputByKey) {
            if (DEFAULT_CONTEXT[inputKey]) {
                if (inputByKey[inputKey].getType() === "Password" && (!DEFAULT_CONTEXT.debugMode || DEFAULT_CONTEXT.debugMode === "false")) {
                    iab.log('Ignoring default value for password field: ' + inputKey);
                } else {
