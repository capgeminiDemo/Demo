jQuery.sap.declare("com.sap.northwind.Component");
jQuery.sap.require("com.sap.northwind.MyRouter");
...
sap.ui.core.UIComponent.extend("com.sap.northwind.Component", {
	metadata: {
		...
		config: {
			...
			serviceConfig: {
				name: "ODataDemo",
				serviceUrl: "/destinations/Northwind/V2/OData/OData.svc/"
			}
		},

		routing: {
			config: {
				routerClass: com.sap.northwind.MyRouter,
				viewType: "XML",
	...
	init: function() {
		...
		var oRootPath = jQuery.sap.getModulePath("com.sap.northwind");
		...
		var oModel;
		var externalURL = com.sap.northwind.dev.devapp.externalURL;
		var appContext;
		if (com.sap.northwind.dev.devapp.devLogon) {
			appContext = com.sap.northwind.dev.devapp.devLogon.appContext;
		}
