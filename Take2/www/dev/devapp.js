jQuery.sap.declare("com.sap.northwind.dev.devapp");
jQuery.sap.require("com.sap.northwind.dev.devlogon");

com.sap.northwind.dev.devapp = {
	smpInfo: {},
	externalURL: null,
	...
	onDeviceReady: function() {
		if (window.sap_webide_FacadePreview) {
			...
			var that = com.sap.northwind.dev.devapp;
			$.getJSON("project.json", function(data) {
				...
				if (that.smpInfo.server && that.smpInfo.server.length > 0) {
					...
					that.devLogon = new com.sap.northwind.dev.devlogon();
