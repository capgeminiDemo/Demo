jQuery.sap.require("com.sap.northwind.util.Formatter");
jQuery.sap.require("com.sap.northwind.util.Controller");

com.sap.northwind.util.Controller.extend("com.sap.northwind.view.Detail", {
	...
	onRouteMatched: function(oEvent) {
		...
		jQuery.when(this.oInitialLoadFinishedDeferred).then(jQuery.proxy(function() {
			...
			oIconTabBar.getItems().forEach(function(oItem) {
				oItem.bindElement(com.sap.northwind.util.Formatter.uppercaseFirstChar(oItem.getKey()));
			});
	...
	showEmptyView: function() {
		this.getRouter().myNavToWithoutHash({
			...
			targetViewName: "com.sap.northwind.view.NotFound",
			targetViewType: "XML"
		});
	},
